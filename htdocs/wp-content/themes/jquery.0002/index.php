...
<?php
$pageposts = $wpdb->get_results("SELECT *, REPLACE(post_name, 'jQuery.', '') as trimname FROM wp_posts as p WHERE p.post_status='publish' AND p.post_type = 'post' AND p.post_date < NOW() ORDER BY trimname;");
